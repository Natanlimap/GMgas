                ...
                <div className=' my-5 flex flex-row flex-wrap justify-center '>
                    <div className='flex flex-col justify-center rounded-lg' style={{ backgroundColor: '#253791' }}>
                        <div className='w-52 h-52 my-10 '>
                            ...
                            <div className='flex flex-row text-lg  text-left mt-4 mx-3 text-white'>
                    ...
                    <div className='mt-2 sm:mt-0 flex flex-col justify-center rounded-lg' style={{ backgroundColor: '#253791' }}>
                        <div className='w-52 h-52  my-10 '>
